        ...
        <div class="fixMiddle loginBoxsize" style="width: 50%; height: auto;">
            ...
            <form action="upload.php" method="POST" enctype="multipart/form-data">
                <div class="box__input" style="text-align: center;">
                    <input type="file" name="file[]" id="img_upload" class="box__file inputfile inputfile-3" data-multiple-caption="{count} files selected" multiple required accept="video/mp4,video/x-m4v,video/*,image/*">
