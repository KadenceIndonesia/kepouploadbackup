...
(function ($) {
    ...
    $.fn.imageUploader = function (options) {
        ...
        let defaults = {
            ...
            label: 'Klik di sini untuk Upload file'
        };
        ...
        let createContainer = function () {
            ...
            let $container = $('<div>', {class: 'image-uploader'}),
                ...
                $input = $('<input>', {
                    type: 'file',
                    id: plugin.settings.imagesInputName + '-' + 12345,
                ...
                $textContainer = $('<div> abc', {
                    class: 'upload-text'
                }).appendTo($container),

                // Create the icon and append it to the text container
                $i = $('<i>', {class: 'material-icons cloud_label', text: 'cloud_upload'}).appendTo($textContainer),
                $i2 = $('<i>', {class: 'material-icons addlabel', text: 'add'}).appendTo($textContainer),
